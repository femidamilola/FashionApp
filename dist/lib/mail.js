...
const sendEmail = (email, token, res) => __awaiter(this, void 0, void 0, function* () {
    const provider = {
        server: {
            host: process.env.SMTP_HOST || "smtp.gmail.com",
            port: Number(process.env.SMTP_PORT) || 465,
            auth: {
                user: process.env.SMTP_USER || "ogolagunju@gmail.com",
                pass: process.env.SMTP_PASSWORD || "scufxkatthucetqp",
            },
            secure: true,
        },
